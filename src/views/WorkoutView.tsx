...
const WorkoutView: React.FC = () => {
    const { currentTimer, startWorkout, resetWorkout, fastForward, isWorkoutRunning, toggleWorkout, timers } = useTimerContext();
    ...
    const renderTimerDetails = () => {
        ...
        return (
            ...
            >
                <h3 style={{ fontSize: '1.5rem', color: '#2C4001', marginBottom: '10px' }}>Current Timer: {type.charAt(0).toUpperCase() + type.slice(1)}</h3>
    ...
    return (
        <div style={{ padding: '20px', textAlign: 'center' }}>
            ...
            {currentTimer?.config?.totalSeconds && <TimeDisplay timeInMs={currentTimer.config.totalSeconds * 1000} />}
